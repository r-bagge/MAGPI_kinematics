...
def BPT_plots(output_file, sample_file, n_re):
    ...
    for g in galaxies:
        ...
        OIII = fits_file["OIII_5008_F"].data
        OIII_err = fits_file["OIII_5008_FERR"].data
        NII = fits_file["NII_6585_F"].data
        NII_err = fits_file["NII_6585_FERR"].data
        OI = fits_file["OI_6302_F"].data
        OI_err = fits_file["OI_6302_FERR"].data
